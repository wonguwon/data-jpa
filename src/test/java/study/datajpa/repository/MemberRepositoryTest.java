...
class MemberRepositoryTest {
    ...
    public void returnType(){
       ...
       List<Member> aaa1 = memberRepository.findListByUsername("AAA"); //list조회시 조심 -> 값이 없을 때 빈 컬랙션 반환함
       Member aaa2 = memberRepository.findMemberByUsername("AAA"); //꺼냈을 때 없으면 null반환됨, 기본jpa는 에러반환
    ...
    public void bulkUpdate() throws Exception {
        ...
        //em.clear();  //벌크연산 이후에는 항상 영속성컨텍스트를 초기화해줘야함 또는 @Modyfiying(clearAutomatically = true)옵션 부여
